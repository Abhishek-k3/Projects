...
# Features!
  ...
  - Schedule a message whenever needed
### Requirements
...
Step 3: Paste the driver in the directory where the .py file is present.

Step 4: When the browser is opened web.whatsapp.com will be opened and will ask to scan a QR code when you it first time

Step 5: After Scanning the QR code, you will be asked to press Enter Key in the terminal.
